...
//        echo($this->obj->db->last_query());die();
        if ($query->num_rows() == 1) {
            ...
            $this->obj->session->set_flashdata('user', $this->obj->lang->line('text_succ_logout'));
            ...
            $this->obj->session->set_flashdata('user', $this->obj->lang->line('text_err_login'));
    ...
    function logout() {
        $this->_destroy_session();
        $this->obj->session->set_flashdata('notification', $this->obj->lang->line('text_succ_logout'));
    }
