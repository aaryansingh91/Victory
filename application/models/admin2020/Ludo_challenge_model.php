...
//        );
    ...
    public function getchallengeById($ludo_challenge_id) {
        $this->db->select('l.*,m.first_name,m.user_name,m.last_name,m.profile_image,m1.first_name  as accepted_first_name,m1.user_name  as accepted_user_name,m1.last_name  as accepted_last_name,m1.profile_image as accepted_profile_image,g.game_logo');
