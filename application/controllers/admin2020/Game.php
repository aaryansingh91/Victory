...
class Game extends CI_Controller
{
    ...
    function index()
    {
        ...
        $data['home_game'] = $this->game->home_game();
    ...
    function insert()
    {
        ...
        if ($this->input->post('submit') == $this->lang->line('text_btn_submit')) {
            ...
            $data['coming_soon'] = $this->input->post('coming_soon');
            $data['home_game_id'] = $this->input->post('home_game_id');
            ...
            $this->form_validation->set_rules('home_game_id', 'lang:text_game', 'required', array('required' => 'Please select Home Game'));
