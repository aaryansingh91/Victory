...
class Youtube extends CI_Controller {
    ...
    function setDatatableYoutubeLink() {
        ...
        while ($row = mysqli_fetch_array($query)) {
            ...
            $edit = '<a class="" style="font-size:18px;" data-original-title="Edit" data-placement="top"  href=' . base_url() . $this->path_to_view_admin . 'youtube/edit/' . $row['youtube_link_id'] . '><i class="fa fa-edit"></i></a>&nbsp; ';
            if ($this->system->demo_user == 1) {
                ...
                $delete = '<a  class="" data-original-title="Delete" data-placement="top"  style="cursor: pointer;font-size:18px;color:#007bff" onClick="javascript: confirmDeleteYoutubeLink(document.frmyoutubelist,' . $row['youtube_link_id'] . ');"><i class="fa fa-trash-o"></i> </a>&nbsp; ';
            }
