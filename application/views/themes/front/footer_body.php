...
<footer class="bm-section-padding bm-dark-bg" id="footer">
    ...
    <?php if($this->system->whatsapp_support != ""){ ?>
        <div class="whatsapp-wrapper"> 
            <a href="https://api.whatsapp.com/send?phone=<?php echo $this->system->whatsapp_support; ?>" target="_blank"> 
                <img src="<?php echo base_url().'uploads/Whatsapp-60.png'?>"> 
            </a> 
        </div>
    <?php } ?>
</footer>