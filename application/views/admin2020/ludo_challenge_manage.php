            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h1 class="h2"><?php echo $this->lang->line('text_ludo_challenge');?></h1>
                        <?php if (isset($btn)) { ?>
                            <a class="btn btn-sm btn-outline-secondary" href="<?php echo base_url() . $this->path_to_view_admin; ?>ludo_challenge/insert">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form name="frmludochallengelist" method="post" action="<?php echo base_url() . $this->path_to_view_admin ?>ludo_challenge">
                                <div class=" table-responsive">
                                    <table id="manage_tbl" class="table  table-striped table-bordered">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th><?php echo $this->lang->line('text_challenge');?></th>
												<th><?php echo $this->lang->line('text_game');?></th>
                                                <th><?php echo $this->lang->line('text_date_created');?></th>
                                    ...
                                    <input type="hidden" name="ludo_challenge_id" />
