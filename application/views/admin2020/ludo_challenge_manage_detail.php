                              ...
                              <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-3">
                                        ...
                                        <br/>
                                        <h6>Username: <?php echo $challenge_detail['user_name']; ?></h6>
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        ?>
                                        <h6>Username: <?php echo $challenge_detail['accepted_user_name']; ?></h6>
                              ...
                              <div class="card-body">
                                    <form id="challenge-result-form"  enctype="multipart/form-data" method="POST" action="<?php echo base_url() . $this->path_to_view_admin ?>ludo_challenge/upload_result">
                                                ...
                                                <label class="col-md-3" for="member_id"><b><?php echo $this->lang->line('text_choose_user'); ?><span class="required" aria-required="true"> * </span></b></label>                                                
                                                    <div class="col-md-9">
                                                        <div class="custom-control custom-radio custom-control-inline">
                                                            ...
                                                            <label class="custom-control-label" for="added_user"><?php echo $challenge_detail['user_name']; ?></label>
                                                        </div>
                                                        <div class="custom-control custom-radio custom-control-inline">
                                                            ...
                                                            <label class="custom-control-label" for="accepted_user"><?php echo $challenge_detail['accepted_user_name']; ?></label>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 form-group">
                                                <label class="col-md-3" for="penlty_user"><b><?php echo "Penalty User"; ?><span class="required" aria-required="true"> * </span></b></label>                                                
                                                    <div class="col-md-9">
                                                    <select name="penlty_user" class="form-control challenge_status" required>
                                                        <option>Select</option>
                                                        <option value="<?php echo $challenge_detail['accepted_member_id']; ?>"><?php echo $challenge_detail['accepted_user_name']; ?></option>
                                                        <option value="<?php echo $challenge_detail['member_id']; ?>"><?php echo $challenge_detail['user_name']; ?></option>
                                                    </select>
                                                    </div>
                                                    <?php echo form_error('penlty_user', '<em style="color:red">', '</em>'); ?>
                                            </div>
                                            <div class="col-md-12 form-group">
                                            <label class="col-md-3" for="penlty"><b><?php echo "penalty amount"; ?><span class="required" aria-required="true"> * </span></b></label>
                                                <div class="col-md-9">
                                                    <input type="number" class="form-control" name="penlty">
                                                </div>
                                                <?php echo form_error('penlty', '<em style="color:red">', '</em>'); ?>
                                            </div>
