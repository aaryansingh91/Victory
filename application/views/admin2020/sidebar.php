    ...
    <ul class="nav flex-column list-group list-group-flush">
        <li class="nav-item">
            <a class="nav-link <?php if ($this->uri->segment('2') == 'dashboard')
                echo 'active'; ?>"
                href="<?php echo base_url() . $this->path_to_view_admin ?>dashboard/">
        ...
        if ($this->functions->check_permission('members') || $this->functions->check_permission('register_referral') || $this->functions->check_permission('referral')) {
            ...
            ?>" data-toggle="collapse" href="#item-6">
                    ...
                    <?php echo $this->lang->line('text_users'); ?> <span class="float-right"><i
            ...
            ?>">
                    <ul class="nav flex-column ml-3">
                        ...
                        if ($this->functions->check_permission('members')) {
                            ?>
                            <li class="nav-item">
                                <a class="nav-link <?php if ($this->uri->segment('2') == 'members')
                                    echo 'active'; ?>"
                                    href="<?php echo base_url() . $this->path_to_view_admin ?>members/">
                        ...
                        if ($this->functions->check_permission('register_referral')) {
                            ?>
                            <li class="nav-item">
                                <a class="nav-link <?php if ($this->uri->segment('2') == 'register_referral')
                                    echo 'active'; ?>"
                                    href="<?php echo base_url() . $this->path_to_view_admin ?>register_referral/">
                        ...
                        if ($this->functions->check_permission('referral')) {
                            ?>
                            <li class="nav-item">
                                <a class="nav-link <?php if ($this->uri->segment('2') == 'referral')
                                    echo 'active'; ?>"
                                    href="<?php echo base_url() . $this->path_to_view_admin ?>referral/">
                                    <i class="fa fa-user-plus"></i>
        ...
        if ($this->functions->check_permission('game') || $this->functions->check_permission('matches') || $this->functions->check_permission('image') || $this->functions->check_permission('ludo_challenge')) {
            ...
            ?>" data-toggle="collapse" href="#item-7">
                    ...
                    <?php echo $this->lang->line('text_games'); ?> <span class="float-right"><i
                            class="fa fa-angle-down"></i></span>
                </a>
                <div id="item-7" class="collapse 
            <?php
            if (($this->uri->segment('2') == 'game') || ($this->uri->segment('2') == 'home_game') || ($this->uri->segment('2') == 'matches') || ($this->uri->segment('2') == 'image') || ($this->uri->segment('2') == 'ludo_challenge'))
                echo 'show';
            ?>">
                    <ul class="nav flex-column ml-3">
                        <?php
                        if ($this->functions->check_permission('home_game')) {
                            ?>
                            <li class="nav-item">
                                <a class="nav-link <?php if ($this->uri->segment('2') == 'home_game')
                                    echo 'active'; ?>"
                        ...
                        if ($this->functions->check_permission('game')) {
                            ?>
                            <li class="nav-item">
                                <a class="nav-link <?php if ($this->uri->segment('2') == 'game')
                                    echo 'active'; ?>"
                                    href="<?php echo base_url() . $this->path_to_view_admin ?>game/">
                                    <i class="fa fa-gamepad"></i>
                                    <?php echo "Sub Games" ?>
                                </a>
                            </li>
                        ...
                        if ($this->functions->check_permission('matches')) {
                            ?>
                            <li class="nav-item">
                                <a class="nav-link <?php if ($this->uri->segment('2') == 'matches')
                                    echo 'active'; ?>"
                                    href="<?php echo base_url() . $this->path_to_view_admin ?>matches/">
                                    <i class="fa fa-gamepad"></i>
                        ...
                        if ($this->functions->check_permission('ludo_challenge')) {
                            ?>
                            <li class="nav-item">
                                <a class="nav-link <?php if ($this->uri->segment('2') == 'ludo_challenge')
                                    echo 'active'; ?>"
                                    href="<?php echo base_url() . $this->path_to_view_admin ?>ludo_challenge/">
                        ...
                        if ($this->functions->check_permission('image')) {
                            ?>
                            <li class="nav-item">
                                <a class="nav-link <?php if ($this->uri->segment('2') == 'image')
                                    echo 'active'; ?>"
                                    href="<?php echo base_url() . $this->path_to_view_admin ?>image/">
        ...
        if ($this->functions->check_permission('product') || $this->functions->check_permission('order') || $this->functions->check_permission('courier')) {
            ...
            ?>" data-toggle="collapse" href="#item-4">
                    ...
                    <?php echo $this->lang->line('text_shop'); ?> <span class="float-right"><i
                            class="fa fa-angle-down"></i></span>
                </a>
            ...
            ?>">
                    <ul class="nav flex-column ml-3">
                        ...
                        if ($this->functions->check_permission('product')) {
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?php if ($this->uri->segment('2') == 'product')
                                    echo 'active'; ?>"
                                    href="<?php echo base_url() . $this->path_to_view_admin ?>product/">
                        ...
                        if ($this->functions->check_permission('order')) {
                            ?>
                            <li class="nav-item">
                                <a class="nav-link <?php if ($this->uri->segment('2') == 'order')
                                    echo 'active'; ?>"
                                    href="<?php echo base_url() . $this->path_to_view_admin ?>order/">
                        ...
                        if ($this->functions->check_permission('courier')) {
                            ?>
                            <li class="nav-item">
                                <a class="nav-link <?php if ($this->uri->segment('2') == 'courier')
                                    echo 'active'; ?>"
                                    href="<?php echo base_url() . $this->path_to_view_admin ?>courier/">
        ...
        if ($this->functions->check_permission('country')) {
            ?>
            <li class="nav-item">
                <a class="nav-link <?php if ($this->uri->segment('2') == 'country')
                    echo 'active'; ?>"
                    href="<?php echo base_url() . $this->path_to_view_admin ?>country/">
                    <i class="fa fa-gamepad"></i>
        ...
        if ($this->functions->check_permission('pgorder')) {
            ?>
            <li class="nav-item">
                <a class="nav-link <?php if ($this->uri->segment('2') == 'pgorder')
                    echo 'active'; ?>"
                    href="<?php echo base_url() . $this->path_to_view_admin ?>pgorder/">
        ...
        if ($this->functions->check_permission('withdraw')) {
            ?>
            <li class="nav-item">
                <a class="nav-link <?php if ($this->uri->segment('2') == 'withdraw' || $this->uri->segment('3') === '')
                    echo 'active'; ?>"
                    href="<?php echo base_url() . $this->path_to_view_admin ?>withdraw/">
        ...
        if ($this->functions->check_permission('topplayers') || $this->functions->check_permission('leaderboard')) {
            ...
            <li class="nav-item">
                ...
                ?>" data-toggle="collapse" href="#item-3">
                    ...
                    <?php echo $this->lang->line('text_reports'); ?> <span class="float-right"><i
                            class="fa fa-angle-down"></i></span>
                </a>
            ...
            ?>">
                    <ul class="nav flex-column ml-3">
                        ...
                        if ($this->functions->check_permission('topplayers')) {
                            ?>
                            <li class="nav-item">
                                <a class="nav-link <?php if ($this->uri->segment('2') == 'topplayers')
                                    echo 'active'; ?>"
                                    href="<?php echo base_url() . $this->path_to_view_admin ?>topplayers/">
                                    <i class="fa fa-trophy"></i>
                        ...
                        if ($this->functions->check_permission('leaderboard')) {
                            ?>
                            <li class="nav-item">
                                <a class="nav-link <?php if ($this->uri->segment('2') == 'leaderboard')
                                    echo 'active'; ?>"
                                    href="<?php echo base_url() . $this->path_to_view_admin ?>leaderboard/">
        ...
        if ($this->functions->check_permission('telegram_support')) {
            ?>
            <li class="nav-item">
                <a class="nav-link <?php if ($this->uri->segment('2') == 'telegram_support')
                    echo 'active'; ?>"
        ...
        if ($this->functions->check_permission('announcement')) {
            ?>
            <li class="nav-item">
                <a class="nav-link <?php if ($this->uri->segment('2') == 'announcement')
                    echo 'active'; ?>"
                    href="<?php echo base_url() . $this->path_to_view_admin ?>announcement/">
        ...
        if ($this->functions->check_permission('lottery')) {
            ?>
            <li class="nav-item">
                <a class="nav-link <?php if ($this->uri->segment('2') == 'lottery')
                    echo 'active'; ?>"
                    href="<?php echo base_url() . $this->path_to_view_admin ?>lottery/">
        ...
        if ($this->functions->check_permission('page') || $this->functions->check_permission('download') || $this->functions->check_permission('features') || $this->functions->check_permission('homeheader') || $this->functions->check_permission('tab_content') || $this->functions->check_permission('how_to_play') || $this->functions->check_permission('screenshots')) {
            ...
            ?>" data-toggle="collapse" href="#item-5">
                    ...
                    <?php echo $this->lang->line('text_website_setting'); ?> <span class="float-right"><i
                            class="fa fa-angle-down"></i></span>
                </a>
            ...
            ?>">
                    <ul class="nav flex-column ml-3">
                        ...
                        if ($this->functions->check_permission('page')) {
                            ?>
                            <li class="nav-item">
                                <a class="nav-link <?php if ($this->uri->segment('2') == 'page')
                                    echo 'active'; ?>"
                                    href="<?php echo base_url() . $this->path_to_view_admin ?>page/">
                        ...
                        if ($this->functions->check_permission('features') || $this->functions->check_permission('homeheader') || $this->functions->check_permission('tab_content') || $this->functions->check_permission('how_to_play') || $this->functions->check_permission('screenshots')) {
                            ...
                            <li class="nav-item">
                                ...
                                ?>" data-toggle="collapse" href="#item-2">
                                    <i class="fa fa-home"></i>
                                    <?php echo $this->lang->line('text_home_page_setting'); ?> <span class="float-right"><i
                                            class="fa fa-angle-down"></i></span>
                                </a>
        ...
        if ($this->functions->check_permission('appsetting') || $this->functions->check_permission('currency') || $this->functions->check_permission('method') || $this->functions->check_permission('pgdetail') || $this->functions->check_permission('youtube') || $this->functions->check_permission('banner')) {
            ...
            ?>" data-toggle="collapse" href="#item-1">
                    <i class="fa fa-cogs"></i>
                    <?php echo $this->lang->line('text_appsetting'); ?> <span class="float-right"><i
                            class="fa fa-angle-down"></i></span>
                </a>
        ...
        if ($this->session->userdata('id') == 1) {
            ...
            <li class="nav-item">
                <a class="nav-link <?php if ($this->uri->segment('2') == 'admin')
                    echo 'active'; ?>"
                    href="<?php echo base_url() . $this->path_to_view_admin ?>admin/">
                    <i class="fa fa-users"></i>
        ...
        if ($this->functions->check_permission('license')) {
            ?>
            <li class="nav-item">
                <a class="nav-link <?php if ($this->uri->segment('2') == 'license')
                    echo 'active'; ?>"
                    href="<?php echo base_url() . $this->path_to_view_admin ?>license/">
