        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div
                    ...
                    <h1 class="h2">Home Games</h1>
                    <?php if (isset($btn)) { ?>
                        <a class="btn btn-sm btn-outline-secondary"
                            href="<?php echo base_url() . $this->path_to_view_admin; ?>home_game/insert">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form name="frmgamelist" method="post"
                            action="<?php echo base_url() . $this->path_to_view_admin ?>home_game">
                                            ...
                                            <tr>
                                                <th colspan="6">
                                                    ...
                                                    <select class="multi_action form-control d-inline w-auto ml-2">
                                                        ...
                                                        <option value="delete">
                                                            <?php echo $this->lang->line('text_delete'); ?>
                                                        </option>
                                                        <option value="change_publish">
                                                            <?php echo $this->lang->line('text_change_status'); ?>
                                                        </option>
                                                    </select>
                                                </th>
                                            </tr>
