    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div
                    ...
                    <?php if (isset($btn)) { ?>
                        <a class="btn btn-sm btn-outline-secondary"
                            href="<?php echo base_url() . $this->path_to_view_admin; ?>telegram_support/insert">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form name="frmtelegramlist" method="post"
                            action="<?php echo base_url() . $this->path_to_view_admin ?>telegram_support">
                            <div class=" table-responsive">
                                ...
                                <input type="hidden" name="telegramid" />
