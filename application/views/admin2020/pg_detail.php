                                ...
                                <div class="card-body">
                                    <div class="col-md-12">
                                        ...
                                        <?php } elseif ($pgdetail['payment_name'] == 'Offline') {
                                            ...
                                            <?php
                                        } elseif ($pgdetail['payment_name'] == 'UPITranzact') {
                                            ?>
                                            <form method="POST" class="member_form" name="validate" id="validate11" action="<?php echo base_url() . $this->path_to_view_admin ?>pgdetail">
                                                <input id="id" type="hidden" class="form-control" name="id" value="<?php
                                                if ($pgdetail['id']) {
                                                    echo $pgdetail['id'];
                                                } elseif (isset($id)) {
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="payment_description"  id="payment_description_label">API End Point</label>
                                                        <input id="payment_description" type="text" class="form-control" name="payment_description" value="<?php
                                                        if ($pgdetail['payment_description']) {
                                                            echo $pgdetail['payment_description'];
                                                        } else if (isset($payment_description)) {
                                                            echo $payment_description;
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="mkey"  id="mkey_label">Public Key</label>
                                                        <input id="mkey" type="text" class="form-control" name="mkey" value="<?php
                                                        if ($pgdetail['mkey']) {
                                                            echo $pgdetail['mkey'];
                                                        } else if (isset($mkey)) {
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="wname">Secret Key</label>
                                                        <input id="wname" type="text" class="form-control" name="wname" value="<?php
                                                        if ($pgdetail['wname']) {
                                                            echo $pgdetail['wname'];
                                                        } else if (isset($wname)) {
                                                ...
                                                <div class="form-group text-center">
                                                    <input type="submit" value="<?php echo $this->lang->line('text_btn_update'); ?>" name="update_upitranzact" class="btn btn-primary " <?php
                                                    if ($this->system->demo_user == 1) {
                                                        echo 'disabled';
                                                    }
                                                    ?>>     
                                            ...
                                            <?php
                                        } elseif ($pgdetail['payment_name'] == 'UPITranzact Business') {
                                            ?>
                                            <form method="POST" class="member_form" name="validate" id="validate11" action="<?php echo base_url() . $this->path_to_view_admin ?>pgdetail">
                                                <input id="id" type="hidden" class="form-control" name="id" value="<?php
                                                if ($pgdetail['id']) {
                                                ...
                                                <div class="form-group text-center">
                                                    <input type="submit" value="<?php echo $this->lang->line('text_btn_update'); ?>" name="update_upitranzact_business" class="btn btn-primary " <?php
                                                    if ($this->system->demo_user == 1) {
                                                        echo 'disabled';
                                                    }
                                                    ?>>     
