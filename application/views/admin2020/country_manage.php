            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        ...
                        <?php if (isset($btn)) { ?>
                            <a class="btn btn-sm btn-outline-secondary" href="<?php echo base_url() . $this->path_to_view_admin; ?>country/insert">
                    ...
                    <div class="row">                                              
                        <div class="col-md-12">
                            <form name="frmcountrylist" method="post" action="<?php echo base_url() . $this->path_to_view_admin ?>country">
                                    ...
                                    <table id="manage_tbl" class="table  table-striped table-bordered">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th><?php echo $this->lang->line('text_country'); ?></th>
                                                <th><?php echo $this->lang->line('text_country_name'); ?></th>
                                                <th><?php echo $this->lang->line('text_country_code'); ?></th>
