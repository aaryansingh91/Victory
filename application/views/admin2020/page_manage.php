                ...
                <div class="container-fluid">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        ...
                        <div class="btn-toolbar mb-2 mb-md-0">
                            <?php if (isset($btn)) { ?>
                                <a class="btn btn-sm btn-outline-secondary" href="<?php echo base_url() . $this->path_to_view_admin; ?>page?action=add">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="portlet-body">
                                ...
                                <form name="frmpagelist" method="post" action="<?php echo base_url() . $this->path_to_view_admin ?>page">
                                        ...
                                        <table class="table  table-striped table-bordered " id="manage_tbl">
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <th><?php echo $this->lang->line('text_page_title'); ?></th>
                                                    <th><?php echo $this->lang->line('text_page_slug'); ?></th>
