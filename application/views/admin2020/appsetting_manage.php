...
<html dir='<?php echo $dir; ?>'>
    ...
    <body>
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                                        ...
                                        <form class="needs-validation"  id="app-upload-form"  enctype="multipart/form-data" novalidate="" method="POST" action="<?php if ($Action == $this->lang->line('text_action_add')) { ?><?php echo base_url() . $this->path_to_view_admin ?>appsetting<?php } ?>">     
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input id="app_version" type="number" min="1" class="form-control" name="app_version">                                                   
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12">
                            <div class="card bg-light text-dark">
                                <div class="card-header"><strong>Reset Leaderboard</strong></div>
                                <div class="card-body">
                                    <div class="row">
                                        <form class="needs-validation"    enctype="multipart/form-data" novalidate="" method="POST" action="<?php if ($Action == $this->lang->line('text_action_add')) { ?><?php echo base_url() . $this->path_to_view_admin ?>appsetting<?php } ?>"> 
                                            <div class="form-group col-md-12">
                                                <input type="submit" value="Reset leaderboard" name="reset_leaderboard_submit" class="btn btn-primary">
                                                <input type="submit" value="Show all" name="show_all_leaderboard_submit" class="btn btn-secondary ">                                          
                                            </div> 
                                        </form>
                                    </div>
                                </div>
                    ...
                    <?php echo form_error('announcement_desc', '<em style="color:red">', '</em>'); ?>
                                                                ...
                                                                <div class="form-group text-center">
                                                                    <input type="submit" value="<?php echo $this->lang->line('text_btn_submit'); ?>" name="announcement_submit" class="btn btn-primary ">    
                                    ...
                                    <div class="col-md-12">
                                        <form class="needs-validation"  id="app-form"  enctype="multipart/form-data" novalidate="" method="POST" action="<?php if ($Action == $this->lang->line('text_action_add')) { ?><?php echo base_url() . $this->path_to_view_admin ?>appsetting<?php } ?>">     
                                            ...
                                            ?>">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="msg91_route "><?php echo $this->lang->line('text_msg91_route'); ?><span class="required" aria-required="true"> * </span></label>
                                            ...
                                            <h6><b><?php echo $this->lang->line('text_google_analytics_setting'); ?></b></h6>
                                            <hr>
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    <label for="google_analytics "><?php echo $this->lang->line('text_google_analytics'); ?><span class="required" aria-required="true"> * </span>
                                                        <a href="https://www.youtube.com/watch?v=UuE37-MM1ws" target="_blank" style="color:#000;"><i class="fa fa-question-circle "></i></a>
                                                    </label>
                                                    <div class="form-group col-md-12">
                                                        <div class="custom-control custom-radio custom-control-inline">
                                                            <input id="google_analytics_yes" name="google_analytics" type="radio" class="custom-control-input" value="yes" <?php
                                                                                                                                                                            if (isset($google_analytics) && $google_analytics == 'yes') {
                                                                                                                                                                                echo 'checked';
                                                                                                                                                                            } elseif (isset($this->system->google_analytics) && $this->system->google_analytics == 'yes') {
                                                                                                                                                                                echo 'checked';
                                                                                                                                                                            }
                                                                                                                                                                            ?>>&nbsp;
                                                            <label class="custom-control-label" for="google_analytics_yes"><?php echo $this->lang->line('text_yes'); ?></label>
                                                        </div>
                                                        <div class="custom-control custom-radio custom-control-inline">
                                                            <input id="google_analytics_no" name="google_analytics" type="radio" class="custom-control-input" value="no" <?php
                                                                                                                                                                            if (isset($google_analytics) && $google_analytics == 'no') {
                                                                                                                                                                                echo 'checked';
                                                                                                                                                                            } elseif (isset($this->system->google_analytics) && $this->system->google_analytics == 'no') {
                                                                                                                                                                                echo 'checked';
                                                                                                                                                                            }
                                                                                                                                                                            ?>>&nbsp;
                                                            <label class="custom-control-label" for="google_analytics_no"><?php echo $this->lang->line('text_no'); ?></label>
                                                        </div>
                                                        <?php echo form_error('google_analytics', '<em style="color:red">', '</em>'); ?>
                                                    </div>
                                                    <div class="google_analytics_code_div <?php
                                                                                    if ((isset($google_analytics) && $google_analytics == 'no'))
                                                                                        echo 'd-none';
                                                                                    elseif (isset($this->system->google_analytics) && $this->system->google_analytics == 'no')
                                                                                        echo 'd-none';
                                                                                    ?>">
                                                        <div class="form-group col-md-12">
                                                            <label for="google_analytics_code"><?php echo $this->lang->line('text_google_analytics_code'); ?><span class="required" aria-required="true"> * </span></label>
                                                            <input id="google_analytics_code" type="text" name="google_analytics_code" class="form-control" value="<?php if (isset($google_analytics_code)) echo $google_analytics_code;
                                                                                                                                                                    elseif (isset($this->system->google_analytics_code)) echo $this->system->google_analytics_code; ?>">
                                                            <?php echo form_error('google_analytics_code', '<em style="color:red">', '</em>'); ?>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <script>
            ...
            $("#app-form").validate({
                rules: {
                    ...
                    google_analytics_code: {
                        required: function() {
                            if ($('input[name="google_analytics"]:checked').val() == "yes") {
                                return true;
                            } else {
                                return false;
                            }
                ...
                messages: {
                    ...
                    place_point_show: {
                        required: '<?php echo $this->lang->line('err_place_point_req'); ?>',
                    },
                    'one_signal_notification': {
                    ...
                    google_analytics_code: {
                        required: '<?php echo $this->lang->line('err_google_analytics_code_req'); ?>',
                    },
                },
                errorPlacement: function (error, element)
                {
            ...
            const maskedValue = smtpPassInput.value.replace(/./g, '*');
            smtpPassInput.value = maskedValue;

            $('input[type=radio][name=google_analytics]').on('change', function() {
                if ($(this).val() == 'yes') {
                    $(".google_analytics_code_div").removeClass("d-none");
                } else {
                    $(".google_analytics_code_div").addClass("d-none");
                }
            });
