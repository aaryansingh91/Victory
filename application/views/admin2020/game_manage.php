        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div
                    ...
                    <h1 class="h2"><?php echo $this->lang->line('text_games'); ?></h1>
                    <?php if (isset($btn)) { ?>
                        <a class="btn btn-sm btn-outline-secondary"
                            href="<?php echo base_url() . $this->path_to_view_admin; ?>game/insert">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form name="frmgamelist" method="post"
                            action="<?php echo base_url() . $this->path_to_view_admin ?>game">
                            <div class=" table-responsive">
                                <table id="manage_tbl" class="table  table-striped table-bordered">
                                    <thead>
                                        <?php if ($this->system->demo_user == 0) { ?>
                                            <tr>
                                                <th colspan="6">
                                                    <label><?php echo $this->lang->line('text_action_perform'); ?></label>
                                                    <select class="multi_action form-control d-inline w-auto ml-2">
                                                        <option value=""><?php echo $this->lang->line('text_select'); ?>
                                                        </option>
                                                        <option value="delete">
                                                            <?php echo $this->lang->line('text_delete'); ?></option>
                                                        <option value="change_publish">
                                                            <?php echo $this->lang->line('text_change_status'); ?></option>
                                                    </select>
                                                </th>
                                            </tr>
                                        <?php } ?>
                                        <tr>
                                            ...
                                            <th><?php echo $this->lang->line('text_game_name'); ?></th>
                                            <th><?php echo $this->lang->line('text_image'); ?></th>
                                            <!-- <th><?php echo $this->lang->line('text_banned'); ?></th> -->
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th><?php echo $this->lang->line('text_game_name'); ?></th>
                                            <th><?php echo $this->lang->line('text_image'); ?></th>
                                            <!-- <th><?php echo $this->lang->line('text_game_banned'); ?></th> -->
                                            <th><?php echo $this->lang->line('text_actions'); ?></th>
                                            <th><?php echo $this->lang->line('text_view'); ?></th>
                                        </tr>
                                    </tfoot>
