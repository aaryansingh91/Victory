...
<?php // $this->load->view($this->path_to_view_admin . 'top_players_manage_datatable_js'); ?>
<?php } ?>
...
<?php if (isset($custom_notification)) { ?>
    <script
        src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-multiselect/0.9.15/js/bootstrap-multiselect.min.js"></script>
<?php } ?>
<?php if (isset($telegram_support)) { ?>
    <?php $this->load->view($this->path_to_view_admin . 'telegram_support_manage_datatable_js'); ?>
    <script src="<?php echo $this->js; ?>telegram_support.js" type="text/javascript"></script>
<?php } ?>
<?php if (isset($telegram_support_addedit)) { ?>
    <script src="<?php echo $this->admin_js; ?>jquery.validate.js"></script>
<?php } ?>
