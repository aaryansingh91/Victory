        ...
        <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form name="frmlotterylist" method="post" action="<?php echo base_url() . $this->path_to_view_admin ?>lottery">
                                    ...
                                    <table id="manage_tbl" class="table  table-striped table-bordered">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th><?php echo $this->lang->line('text_title'); ?></th>
                                                <th><?php echo $this->lang->line('text_time'); ?></th>
                                                <th><?php echo $this->lang->line('text_fees'); ?></th>
                                                <th><?php echo $this->lang->line('text_prize'); ?></th>
                                                <th><?php echo $this->lang->line('text_size'); ?></th>
                                                <th><?php echo $this->lang->line('text_total_joined'); ?></th>
